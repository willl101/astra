...
<a id="deepseek-aidsh-experimental-proactive-screen"></a>

## `@deepseek-ai/dsh-experimental-proactive-screen`

需要：`subprocess` · `agents` · `agentPresets`
...
来源：[`packages/experimental/proactive-screen/src/index.ts:79`](../packages/experimental/proactive-screen/src/index.ts)
