...
Requires: `subprocess` · `agents` · `agentPresets` · `systemPrompt`
...
Source: [`packages/experimental/proactive-screen/src/index.ts:79`](../packages/experimental/proactive-screen/src/index.ts)
